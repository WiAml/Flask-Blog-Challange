...
def index():
    ...
    #Execute a query to real all posts table in the database
    posts = conn.execute('SELECT * FROM posts').fetchall()
    
    #Close the connection
    conn.close()

    #Send the posts to the indext.html template to be displayed
...
def edit(id):
    ...
    #determine if the page was requested with a POST or GET
...
#Delete route will only be proccesed with a POST method
#the post id is the url paramater
